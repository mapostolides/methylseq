...
class MethylSeq(dnaseq.DnaSeq):
    ...
    def bismark_prepare_genome(self):  # Step 1
        ...
        :rtype: list(Job)
        """
        # .dict file needs to be generated for the gatk_depth_of_coverage job of the "metrics" step. The followingcommand generates the file:
        # $ java -jar /hpf/tools/centos6/picard-tools/2.5.0/picard.jar CreateSequenceDictionary R= Homo_sapiens.hg19.fa O= Homo_sapiens.hg19.dict

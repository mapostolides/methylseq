...
def bisulfite_genotyper(input, cpg_output, snp_output):
    jar_file="/hpf/largeprojects/ccmbio/mapostolides/MODULES/BisSNP/1.0.0/BisSNP-1.0.0.jar"
    return Job(
        [input],
        ...
        command="""\
java -Djava.io.tmpdir={tmp_dir} {java_other_options} -Xmx{ram} -jar {jar_file}\\
